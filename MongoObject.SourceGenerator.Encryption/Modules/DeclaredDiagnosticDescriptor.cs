...
namespace MongoObject.SourceGenerator.Encryption.Modules
{
    internal class DeclaredDiagnosticDescriptor
    {
        ...
        public static DiagnosticDescriptor InvalidKmsDoubleAttributeDescriptor { get; set; } = new DiagnosticDescriptor(
            id: "SG0005",
            title: "Property cannot have multiple Kms Attributes",
            messageFormat: "The property '{0}' is invalid. Cannot contain 2 or more Kms Attributes",
            category: "Usage",
            defaultSeverity: DiagnosticSeverity.Error, // This fails the build
            isEnabledByDefault: true);
    }
